...
export BUILDER_IMAGE_NAME="estatero-builder-$BUILD_TARGET-$JOB_NUMBER"
...
if [ "$BUILD_TARGET" = "arm-linux" ]; then
  ...
  export CPPFLAGS="-DDEBUG_LOCKORDER -DENABLE_ESTATERO_DEBUG"
  export PYZMQ=true
  export RUN_TESTS=true
