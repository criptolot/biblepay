# Linearize
Construct a linear, no-fork, best version of the Estatero blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install estatero_hash

https://github.com/estatero/estatero_hash
...
JSON-RPC server. Running `estaterod` or `estatero-qt -server` will be sufficient.
...
* `input`: estaterod blocks/ directory containing blkNNNNN.dat
