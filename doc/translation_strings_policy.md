...
This document provides guidelines for internationalization of the Estatero Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `estatero_en.ts` remains unchanged.
