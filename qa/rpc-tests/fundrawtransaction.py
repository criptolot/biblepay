...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid estatero address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid estatero address" in e.error['message'])
